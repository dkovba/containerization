    ...
    public struct ExtendedAttribute {
        ...
        var hash: UInt32 {
            ...
            for byte in name.utf8 {
                hash = (hash << 5) ^ (hash >> 27) ^ UInt32(byte)
            }
            var i = 0
    ...
    public struct FileXattrsState {
        ...
        public static func read(buffer: [UInt8], start: Int, offset: Int) throws -> [ExtendedAttribute] {
            ...
            while i + 16 <= buffer.count {
                ...
                i += 16
                let endIndex = i + Int(xattrEntry.nameLength)
                ...
                guard valueStart >= 0, valueEnd >= valueStart, valueEnd <= buffer.count else {
                    continue
                }
                ...
                let nullEnd = i + 3
                guard nullEnd < buffer.count else {
                    continue
                }
